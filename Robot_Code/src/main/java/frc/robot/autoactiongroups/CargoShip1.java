...
public class CargoShip1 extends StateMachineDescriptor {
    public CargoShip1(boolean isLeft)
    {
        ...
        */
        ...
        addSequential(new PointCloudWait(DriveTrajectoryGenerator.getInstance().RCargoShip1, 20, 3, 360), 10000);
        ...
        addSequential(new PointCloudWait(DriveTrajectoryGenerator.getInstance().RCargo, 10, 10, 180), 10000);
