...
public class CargoShip2 extends StateMachineDescriptor {
    public CargoShip2() {
        ...
        */
        ...
        addSequential(new PointCloudWait(DriveTrajectoryGenerator.getInstance().CargoShipMid, 20, 100000, 180), 10000);
        ...
        addSequential(new PointCloudWait(DriveTrajectoryGenerator.getInstance().HairpinTurn, 20, 20, 45), 10000);
        ...
        addSequential(new PointCloudWait(DriveTrajectoryGenerator.getInstance().Cargo, 5, 5, 45), 10000);
