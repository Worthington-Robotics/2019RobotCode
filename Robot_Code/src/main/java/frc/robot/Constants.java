...
public class Constants {
    ...
    public static final int GROUND_HATCH = 1;
    public static final int GROUND_CARGO = 2;
    public static final int BOTTOM_HATCH = 3;
    public static final int BOTTOM_CARGO = 4;
    public static final int MID_HATCH = 5;
